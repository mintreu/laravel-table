            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="#" class="text-red-600 hover:text-red-900" @click="[editView=true,listView=false,createView=false]">EditLink </a>
                        <button class="text-indigo-600 hover:text-indigo-900"  @click="[editView=true,listView=false,createView=false]">Edit</button>
                    </td>
                </tr>
